...
var (
	postsFields = []string{"id", "title", "user_id", "nickname", "category_id", "category_name", "source_type", "route", "is_published", "published_at", "is_private", "is_comment_enabled", "is_comment_shown", "created_at", "updated_at"}
